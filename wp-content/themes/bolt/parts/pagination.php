...
$next_post = get_next_post();
	if (empty( $prev_post )) {
		if (is_singular('post')) { ?>
			<a href="<?= site_url();?>/for-our-customers/in-the-news/" class="small-4 columns left back">All News</a>
		<?php }
		...
		if (is_singular('post')) { ?>
			<a href="<?= site_url();?>/for-our-customers/in-the-news/" class="small-4 columns text-right right back">All News</a>
		<?php }
		...
		if (is_singular('post')) { ?>
			<a href="<?= site_url();?>/for-our-customers/in-the-news/" class="small-4 columns text-center left back">All News</a>
		<?php }
